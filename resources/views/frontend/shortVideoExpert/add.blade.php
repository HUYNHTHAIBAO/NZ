                    ...
                    <div class="dashboard__content-wrap">
                        <div class="pb-4">
                            <p class="bg-light p-1"><a class="text-black font_weight_bold" href="{{route('frontend.user.profile')}}"> Tài khoản </a> /
                                <a class="text-black font_weight_bold" href="{{route('frontend.shortVideoExpert.index')}}"> Quản lý video ngắn </a> / <span>Đăng video ngắn</span>
                            </p>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade active show" id="itemTwo-tab-pane" role="tabpanel"
                                        ...
                                        <div class="instructor__profile-form-wrap">
                                            <form action="{{route('frontend.shortVideoExpert.add')}}"
