                    ...
                    <div class="dashboard__content-wrap">
                        <div class="pb-4">
                            <p class="bg-light p-1"><a class="text-black font_weight_bold" href="{{route('frontend.user.profile')}}"> Tài khoản </a> /
                                <a class="text-black font_weight_bold" href="{{route('frontend.youtubeExpert.index')}}">Quản lý video</a> / Cập nhật video</p>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade active show" id="itemTwo-tab-pane" role="tabpanel"
                                        ...
                                        <div class="instructor__profile-form-wrap">
                                            <form action="{{route('frontend.youtubeExpert.edit', $youtubeExpert->id)}}"
...
{{--                                                        <img id="img_preview" src="{{asset('storage/uploads') . '/' . $youtubeExpert->image_file_path ?? ''}}" alt="" style="padding: 0px;display: block; max-width: 200px; height: 200px; object-fit: cover; border: 1px solid #ccc">--}}
{{--                                                    </div>--}}
...
{{--                                                    <textarea id="title" name="title">{{old('title', $youtubeExpert->title ?? '')}}</textarea>--}}
{{--                                                    @if ($errors->has('title'))--}}
...
{{--                                                </div>--}}
                                                <div class="form-grp">
                                                    ...
                                                    <textarea id="link"
                                                              name="link">{{$youtubeExpert->link ?? ''}}</textarea>
                                                    @if ($errors->has('link'))
