                    ...
                    <div class="dashboard__content-wrap">
                        <div class="pb-4">
                            ...
                            <p class="bg-light p-1"><a class="text-black font_weight_bold" href="{{route('frontend.user.profile')}}"> Tài khoản </a>
                                <a class="text-black font_weight_bold" href="{{route('frontend.blogExpert.index')}}"> / Quản lý bài viết</a> / Đăng bài</p>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="itemTwo-tab-pane" role="tabpanel"
                                        ...
                                        <div class="instructor__profile-form-wrap">
                                            <form action="{{route('frontend.blogExpert.create')}}"
                                                ...
                                                <div class="mb-3 col-6" style="margin: 0 auto">
                                                    ...
                                                    <div class="row d-flex align-items-center justify-content-center"
                                                        ...
                                                        <img id="img_preview" src="" alt=""
                                                             style="padding: 0px; display: block; width: 100%; object-fit: cover">
                                                    </div>
