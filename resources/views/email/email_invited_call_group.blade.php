...
<head>
    ...
    <style type="text/css">
        ...
        * {
        ...
        table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_menu_1 .v-padding { padding: 5px 9px !important; } #u_content_heading_1 .v-container-padding-padding { padding: 40px 30px 20px !important; } #u_content_heading_1 .v-font-size { font-size: 28px !important; } #u_content_text_1 .v-container-padding-padding { padding: 0px 10px 10px !important; } #u_content_text_1 .v-font-size { font-size: 13px !important; } #u_content_button_1 .v-size-width { width: 65% !important; } #u_content_button_1 .v-container-padding-padding { padding: 10px 10px 40px !important; } #u_content_social_1 .v-container-padding-padding { padding: 40px 10px 10px !important; } #u_content_text_2 .v-container-padding-padding { padding: 10px 10px 20px !important; } }
    </style>
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                ...
                                                <div class="menu" style="text-align:center;">
                                                    ...
                                                    <a href="https://neztwork.com/" target="_self" style="padding:5px 21px;display:inline-block;color:#000000;font-size:14px;text-decoration:none"  class="v-padding v-font-size">
                                                        Home
                                                    </a>
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                            ...
                                                            <img align="center" border="0" src="https://neztwork.com/storage/email/images9/image-5.gif" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" width="600"/>
                                    ...
                                    <table id="u_content_text_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 50px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                ...
                                                <div class="v-font-size" style="font-family: arial,helvetica,sans-serif; font-size: 14px; line-height: 160%; text-align: justify; word-wrap: break-word;">
                                                    <p style="line-height: 160%;"><strong>Chúc mừng bạn, {{$data->fullname ?? ''}} ơi!</strong> 🎉</p>
                                                    <p style="line-height: 160%;"> </p>
                                                    <p style="line-height: 160%;">Neztwork rất vui mừng thông báo rằng bạn đã nhận được một lời mời đặc biệt từ <strong>bạn của bạn {{$request->user->fullname ?? ''}}</strong> để tham gia một cuộc trò chuyện hấp dẫn cùng <strong>Chuyên gia {{$request->userExpert->fullname ?? ''}}</strong>! 🌟 Đây là cơ hội tuyệt vời để bạn kết nối và học hỏi từ một trong những Creator hàng đầu của chúng tôi.</p>
                                                    <p style="line-height: 160%;"> </p>
                                                    <p style="line-height: 160%;">🗓 <strong>Thông tin chi tiết cuộc gọi:</strong></p>
                                                    <ul>
                                                        <li style="line-height: 22.4px;"><strong>Mã đơn:</strong> {{$request->order_code ?? ''}}</li>
                                                        <li style="line-height: 22.4px;"><strong>Ngày:</strong> {{ format_date_custom($request->date ?? '') }}</li>
                                                        <li style="line-height: 22.4px;"><strong>Giờ:</strong> {{$request->time ?? ''}}</li>
                                                        <li style="line-height: 22.4px;"><strong>Thời lượng cuộc gọi:</strong> {{$request->duration_id ?? ''}} phút</li>
                                                    </ul>
                                                    <p style="line-height: 160%;">🔗 <strong>Link tham gia cuộc gọi:</strong> <a rel="noopener" href="https://neztwork.dev24h.net/meeting.html" target="_new">Nhấn vào đây để tham gia</a><br />🆔 <strong>Mã cuộc họp:</strong> {{$room->rom_code ?? ''}}</p>
                                                    <p style="line-height: 160%;"> </p>
                                                    <p style="line-height: 160%;">Neztwork hiểu rằng hành trình phát triển không phải lúc nào cũng dễ dàng, nhưng mỗi bước đi của bạn đều xứng đáng được ghi nhận 🎉. Chúng tôi tin rằng Chuyên gia {{$request->userExpert->fullname ?? ''}} sẽ mang đến cho bạn những lời khuyên quý giá và cái nhìn sâu sắc 🌟.</p>
                                                    <p style="line-height: 160%;"> </p>
                                                    <p style="line-height: 160%;">Trước cuộc gọi, hãy kiểm tra thông tin và chuẩn bị các câu hỏi để tận dụng cơ hội này. Đây là dịp tuyệt vời để chia sẻ ý tưởng và nhận được thông tin bổ ích từ {{$request->userExpert->fullname ?? ''}} nhé 🌟.</p>
                                                    <p style="line-height: 160%;"> </p>
                                                    <p style="line-height: 160%;">Neztwork rất mong chờ sự tham gia của bạn, và hy vọng buổi trò chuyện này sẽ mang lại nhiều giá trị và cảm hứng cho hành trình của bạn 🚀.</p>
                                                    <p style="line-height: 160%;"> </p>
                                                    <p style="line-height: 160%;"><strong>Trân trọng,</strong><br /><strong>Đội ngũ Neztwork</strong> 🌟</p>
                                                </div>
                                    ...
                                    <table id="u_content_button_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 60px;font-family:arial,helvetica,sans-serif;" align="left">
                                                ...
                                                <div align="center">
                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://neztwork.com/" style="height:37px; v-text-anchor:middle; width:184px;" arcsize="11%"  strokecolor="#916baf" strokeweight="1px" fillcolor="#ffffff"><w:anchorlock/><center style="color:#000000;"><![endif]-->
                                                    <a href="https://neztwork.com/" target="_blank" class="v-button v-size-width v-font-size" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #000000; background-color: #ffffff; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:32%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #916baf; border-top-style: solid; border-top-width: 1px; border-left-color: #916baf; border-left-style: solid; border-left-width: 1px; border-right-color: #916baf; border-right-style: solid; border-right-width: 1px; border-bottom-color: #916baf; border-bottom-style: solid; border-bottom-width: 1px;font-size: 14px;">
                                                        <span class="v-padding" style="display:block;padding:10px 20px;line-height:120%;"><strong><span style="line-height: 16.8px;">Stay Tuned</span></strong></span>
                                                    </a>
                                                        ...
                                                        <table align="center" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px">
                                                            <tbody><tr style="vertical-align: top"><td align="center" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                    <a href="https://www.facebook.com/unlayer" title="Facebook" target="_blank">
                                                                        <img src="https://neztwork.com/storage/email/images9/image-1.png" alt="Facebook" title="Facebook" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    </a>
                                                                </td></tr>
                                                            </tbody></table>
                                                        <!--[if (mso)|(IE)]></td><![endif]-->
                                                        ...
                                                        <table align="center" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px">
                                                            <tbody><tr style="vertical-align: top"><td align="center" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                    <a href="https://twitter.com/unlayerapp" title="Twitter" target="_blank">
                                                                        <img src="https://neztwork.com/storage/email/images9/image-2.png" alt="Twitter" title="Twitter" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    </a>
                                                                </td></tr>
                                                            </tbody></table>
                                                        <!--[if (mso)|(IE)]></td><![endif]-->
                                                        ...
                                                        <table align="center" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px">
                                                            <tbody><tr style="vertical-align: top"><td align="center" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                    <a href="https://www.linkedin.com/company/unlayer/mycompany/" title="LinkedIn" target="_blank">
                                                                        <img src="https://neztwork.com/storage/email/images9/image-3.png" alt="LinkedIn" title="LinkedIn" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    </a>
                                                                </td></tr>
                                                            </tbody></table>
                                                        <!--[if (mso)|(IE)]></td><![endif]-->
                                                        ...
                                                        <table align="center" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 0px">
                                                            <tbody><tr style="vertical-align: top"><td align="center" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                    <a href="https://www.instagram.com/unlayer_official/" title="Instagram" target="_blank">
                                                                        <img src="https://neztwork.com/storage/email/images9/image-4.png" alt="Instagram" title="Instagram" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    </a>
                                                                </td></tr>
                                                            </tbody></table>
                                                        <!--[if (mso)|(IE)]></td><![endif]-->
