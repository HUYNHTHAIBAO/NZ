...
<head>
    ...
    <style type="text/css">
        ...
        * {
        ...
        table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_menu_1 .v-padding { padding: 0px 9px 12px !important; } #u_content_heading_1 .v-container-padding-padding { padding: 40px 10px 0px !important; } #u_content_heading_1 .v-font-size { font-size: 17px !important; } #u_content_heading_1 .v-text-align { text-align: center !important; } #u_content_heading_2 .v-container-padding-padding { padding: 0px 10px !important; } #u_content_heading_2 .v-font-size { font-size: 23px !important; } #u_content_heading_2 .v-text-align { text-align: center !important; } #u_content_image_4 .v-container-padding-padding { padding: 10px !important; } #u_content_heading_4 .v-container-padding-padding { padding: 30px 10px 0px !important; } #u_content_heading_4 .v-text-align { text-align: center !important; } #u_content_text_2 .v-container-padding-padding { padding: 5px 10px 10px !important; } #u_content_text_2 .v-font-size { font-size: 13px !important; } #u_content_text_2 .v-text-align { text-align: justify !important; } #u_content_button_4 .v-text-align { text-align: center !important; } #u_content_button_4 .v-container-padding-padding { padding: 10px 10px 50px !important; } #u_content_image_5 .v-src-width { width: auto !important; } #u_content_image_5 .v-src-max-width { max-width: 65% !important; } #u_content_heading_3 .v-container-padding-padding { padding: 30px 10px 5px !important; } #u_content_heading_3 .v-text-align { text-align: center !important; } #u_content_text_1 .v-container-padding-padding { padding: 0px 10px 30px !important; } #u_content_text_1 .v-font-size { font-size: 12px !important; } #u_content_text_1 .v-text-align { text-align: left !important; } #u_content_heading_5 .v-container-padding-padding { padding: 30px 10px 5px !important; } #u_content_heading_5 .v-text-align { text-align: center !important; } #u_content_text_3 .v-container-padding-padding { padding: 0px 10px 30px !important; } #u_content_text_3 .v-font-size { font-size: 12px !important; } #u_content_text_3 .v-text-align { text-align: left !important; } #u_content_heading_6 .v-container-padding-padding { padding: 30px 20px 10px !important; } #u_content_heading_6 .v-text-align { text-align: left !important; } #u_content_text_4 .v-container-padding-padding { padding: 0px 20px 10px !important; } #u_content_text_4 .v-font-size { font-size: 13px !important; } #u_content_text_4 .v-text-align { text-align: justify !important; } #u_content_social_1 .v-container-padding-padding { padding: 10px 0px 10px 80px !important; } #u_content_heading_7 .v-container-padding-padding { padding: 15px 10px 10px !important; } #u_content_heading_7 .v-text-align { text-align: center !important; } }
    </style>



    <!--[if !mso]><!--><link href="https://fonts.googleapis.com/css?family=Raleway:400,700" rel="stylesheet" type="text/css"><link href="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet" type="text/css"><!--<![endif]-->
...
<table id="u_body" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #ecf0f1;width:100%" cellpadding="0" cellspacing="0">
    ...
    <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            <tr>
                <td background="https://assets.unlayer.com/projects/248776/1725601827175-Neztwork.png" valign="top" width="100%">
                    <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;">
                        <v:fill type="frame" src="https://assets.unlayer.com/projects/248776/1725601827175-Neztwork.png" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
            <![endif]-->
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                        ...
                        <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                            <div style="background-color: #ffffff;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 1px solid #CCC;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->

                                    <table id="u_content_menu_1" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;" align="left">
                                                ...
                                                <div class="menu" style="text-align:center;">
                                                    ...
                                                    <a href="https://neztwork.com/" target="_self" style="padding:21px 15px 12px;display:inline-block;color:#000000;font-family:'Montserrat',sans-serif;font-size:14px;text-decoration:none"  class="v-padding v-font-size">
                                                        HOME
                                                    </a>
                                                    ...
                                                    <a href="https://neztwork.com/gioi-thieu.html" target="_self" style="padding:21px 15px 12px;display:inline-block;color:#000000;font-family:'Montserrat',sans-serif;font-size:14px;text-decoration:none"  class="v-padding v-font-size">
                                                        ABOUT
                                                    </a>
                        ...
                        <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                            <div style="background-color: #ffffff;height: 100%;width: 100% !important;">
                                <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"><!--<![endif]-->
                                    ...
                                    <table id="u_content_heading_1" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:50px 10px 0px 20px;" align="left">

                                                <!--[if mso]><table width="100%"><tr><td><![endif]-->
                                                <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: arial,helvetica,sans-serif; font-size: 18px; font-weight: 400;"><span><span><span><span><span><span><span>Let’s Create</span></span></span></span></span></span></span></h1>
                                    ...
                                    <table id="u_content_heading_2" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 10px 20px;" align="left">

                                                <!--[if mso]><table width="100%"><tr><td><![endif]-->
                                                <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: arial,helvetica,sans-serif; font-size: 26px; font-weight: 400;"><span><span><span><span><span><strong>Something Amazing Together ✨</strong></span></span></span></span></span></h1>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <table id="u_content_image_4" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">


                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 20px;" align="left">

                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">

                                                            <img align="center" border="0" src="https://neztwork.com/storage/email/images/image-7.png" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 90%;max-width: 504px;" width="504" class="v-src-width v-src-max-width"/>
                                    ...
                                    <table id="u_content_heading_4" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 5px 20px;" align="left">

                                                <!--[if mso]><table width="100%"><tr><td><![endif]-->
                                                <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: arial,helvetica,sans-serif; font-size: 19px; font-weight: 400;"><strong>🎉 Neztwork - Chúc mừng, bạn đã đặt lịch tư vấn thành công!</strong></h1>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <table id="u_content_text_2" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 30px 10px 20px;" align="left">

                                                <div class="v-text-align v-font-size" style="font-family: arial,helvetica,sans-serif; font-size: 14px; line-height: 140%; text-align: justify; word-wrap: break-word;">
                                                    <p style="line-height: 140%;"><strong>🎊 Chúc mừng bạn đã hoàn tất đặt lịch tư vấn trên Neztwork!</strong> Chúng tôi hy vọng bạn sẽ có một buổi trao đổi thú vị và mang lại nhiều giá trị. 🌟 Dưới đây là thông tin chi tiết về cuộc gọi của bạn. 📅</p>
                                                </div>
                                    ...
                                    <table id="u_content_button_4" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:15px 60px 50px 15px;" align="left">

                                                <!--[if mso]><style>.v-button {background: transparent !important;}</style><![endif]-->
                                                <div class="v-text-align" align="left">
                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://neztwork.com/" style="height:37px; v-text-anchor:middle; width:157px;" arcsize="11%"  stroke="f" fillcolor="#154e68"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
                                                    <a href="https://neztwork.com/" target="_blank" class="v-button v-font-size" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #154e68; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                                        <span class="v-padding" style="display:block;padding:10px 20px;line-height:120%;">Meet Your Advisor</span>
                                                    </a>
                                    ...
                                    <table id="u_content_image_5" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;" align="left">
            ...
            <div class="u-row-container" style="padding: 0px;background-color: transparent">
                <div class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
                    <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                        ...
                        <!--[if (mso)|(IE)]><td align="center" width="580" style="background-color: #e8e5f2;width: 580px;padding: 0px;border-top: 0px solid transparent;border-left: 10px solid #ffffff;border-right: 10px solid #ffffff;border-bottom: 10px solid #ffffff;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                        <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                            <div style="background-color: #e8e5f2;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 10px solid #ffffff;border-right: 10px solid #ffffff;border-bottom: 10px solid #ffffff;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->

                                    <table id="u_content_heading_3" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 5px 20px;" align="left">

                                                <!--[if mso]><table width="100%"><tr><td><![endif]-->
                                                <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: arial,helvetica,sans-serif; font-size: 18px; font-weight: 400;"><strong>Hãy cùng cập nhật thông tin cuộc gọi!</strong></h1>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <table id="u_content_text_1" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 30px 30px 20px;" align="left">

                                                <div class="v-text-align v-font-size" style="font-family: arial,helvetica,sans-serif; font-size: 14px; color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                    <p style="line-height: 140%;"> </p>
                                                    <ul>
                                                        <li style="line-height: 16.8px;"><strong>Link tham gia:</strong> 🔗 <a rel="noopener" href="https://neztwork.dev24h.net/meeting.html" target="_new">Tham gia cuộc gọi tại đây</a> </li>
                                                        <li style="line-height: 16.8px;"><strong>Mã cuộc họp:</strong> {{$room->rom_code ?? ''}}</li>
                                                    </ul>
                                                </div>
                        ...
                        <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                            <div style="background-color: #e8e5f2;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 10px solid #ffffff;border-right: 10px solid #ffffff;border-bottom: 10px solid #ffffff;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
                                    ...
                                    <table id="u_content_heading_5" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 5px 20px;" align="left">

                                                <!--[if mso]><table width="100%"><tr><td><![endif]-->
                                                <h1 class="v-text-align v-font-size" style="margin: 0px; color: #000000; line-height: 140%; text-align: left; word-wrap: break-word; font-family: arial,helvetica,sans-serif; font-size: 18px; font-weight: 400;"><strong>Bạn đã kiểm tra chi tiết đơn hàng của mình chưa?</strong></h1>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <table id="u_content_text_3" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 30px 30px 20px;" align="left">
                                                ...
                                                <div class="v-text-align v-font-size" style="font-family: arial,helvetica,sans-serif; font-size: 14px; line-height: 140%; text-align: justify; word-wrap: break-word;">
                                                    <ul>
                                                        <li style="line-height: 19.6px;"><strong>Mã đơn hàng:</strong>{{$data->order_code ?? ''}} </li>
                                                        <li style="line-height: 19.6px;"><strong>Chuyên gia :</strong>{{$data->userExpert->fullname ?? ''}}</li>
                                                        <li style="line-height: 19.6px;"><strong>Ngày:</strong> {{ format_date_custom($data->date ?? '') }}</li>
                                                        <li style="line-height: 19.6px;"><strong>Thời gian:</strong>{{$data->time ?? ''}}</li>
                                                        <li style="line-height: 19.6px;"><strong>Thời lượng:</strong> {{$data->duration_id ?? ''}}</li>
                                                        <li style="line-height: 19.6px;"><strong>Trạng thái thanh toán:</strong> Thanh toán thành công</li>
                                                        <li style="line-height: 19.6px;"><strong>Phương thức thanh toán:</strong> Ví điện tử VNPAY</li>
                                                        <li style="line-height: 19.6px;"><strong>Tổng số tiền:</strong> {{format_number_vnd($data->price ?? '')}} vnđ</li>
                                                    </ul>
                                                    <p style="line-height: 140%;"> </p>
                                                </div>
                        ...
                        <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                            <div style="background-color: #ffffff;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
                                    ...
                                    <table id="u_content_text_4" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 60px 10px 35px;" align="left">

                                                <div class="v-text-align v-font-size" style="font-family: arial,helvetica,sans-serif; font-size: 13px; line-height: 170%; text-align: justify; word-wrap: break-word;">
                                                    <p style="line-height: 170%;">✨ <strong>Tại Neztwork, chúng tôi tin rằng “Those who believe will not walk alone”</strong>, và rất vui được đồng hành cùng bạn trong hành trình khám phá và phát triển. 🌟</p>
                                                    <p style="line-height: 170%;"> </p>
                                                    <p style="line-height: 170%;">🔧 Để đảm bảo buổi tư vấn diễn ra suôn sẻ và hiệu quả, chúng tôi khuyến khích bạn kiểm tra lại đường truyền internet và sẵn sàng tham gia đúng giờ. Hãy chuẩn bị các câu hỏi hoặc vấn đề cần giải quyết để cuộc trao đổi trở nên thật giá trị! 💬</p>
                                                    <p style="line-height: 170%;"> </p>
                                                    <p style="line-height: 170%;">📩 <strong>Lưu ý:</strong> Nếu bạn cần thay đổi hoặc có bất kỳ câu hỏi nào liên quan đến buổi tư vấn, đừng ngần ngại liên hệ với đội ngũ hỗ trợ của chúng tôi nhé. Chúng tôi luôn sẵn sàng giúp đỡ! 🤝</p>
                                                    <p style="line-height: 170%;"> </p>
                                                    <p style="line-height: 170%;">Chúc bạn có một trải nghiệm tuyệt vời! 🌈</p>
                                                    <p style="line-height: 170%;"> </p>
                                                    <p style="line-height: 170%;"><strong>Trân trọng,</strong><br />Đội ngũ <strong>Neztwork</strong> 💼</p>
                                                </div>
                                    ...
                                    <table style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 35px;" align="left">
                                    ...
                                    <table id="u_content_social_1" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 10px 35px;" align="left">
                                                    ...
                                                    <div style="display: table; max-width:167px;">
                                                        ...
                                                        <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px">
                                                            <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                    <a href="https://www.instagram.com/neztwork/" title="Instagram" target="_blank">
                                                                        <img src="https://neztwork.com/storage/email/images/image-1.png" alt="Instagram" title="Instagram" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    </a>
                                                                </td></tr>
                                                            </tbody></table>
                                                        <!--[if (mso)|(IE)]></td><![endif]-->
                                                        ...
                                                        <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px">
                                                            <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                    <a href="https://www.tiktok.com/@neztworkvn" title="TikTok" target="_blank">
                                                                        <img src="https://neztwork.com/storage/email/images/image-4.png" alt="TikTok" title="TikTok" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    </a>
                                                                </td></tr>
                                                            </tbody></table>
                                                        <!--[if (mso)|(IE)]></td><![endif]-->
                                                        ...
                                                        <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px">
                                                            <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                    <a href="https://www.facebook.com/neztwork" title="Facebook" target="_blank">
                                                                        <img src="https://neztwork.com/storage/email/images/image-2.png" alt="Facebook" title="Facebook" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    </a>
                                                                </td></tr>
                                                            </tbody></table>
                                                        <!--[if (mso)|(IE)]></td><![endif]-->
                                                        ...
                                                        <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 0px">
                                                            <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                    <a href="https://www.linkedin.com/company/neztwork/?viewAsMember=true" title="LinkedIn" target="_blank">
                                                                        <img src="https://neztwork.com/storage/email/images/image-3.png" alt="LinkedIn" title="LinkedIn" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    </a>
                                                                </td></tr>
                                                            </tbody></table>
                                                        <!--[if (mso)|(IE)]></td><![endif]-->
                        ...
                        <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                            <div style="background-color: #ffffff;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
                                    ...
                                    <table id="u_content_heading_7" style="" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:15px 10px 10px 35px;" align="left">
