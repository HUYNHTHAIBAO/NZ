...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7">
                        {{ Breadcrumbs::render('backend.booking.edit') }}
        </div>
    </div>
    ...
    <div class="row page-titles">
        <div class="col-md-12">
            <div class="card card-outline-info">
                <div class="card-body">
                    <form class="form-horizontal" action="{{route('backend.booking.edit',$data->id )}}" method="post">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label for="desc" class="col-md-12 font_weight_bold">Nội dung </label>
                                    <div class="col-md-12">
                                        <textarea class="form-control" id="desc" name="desc" rows="3">{{old('desc',$data->desc)}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-12 font_weight_bold"> Thứ tự <span class="text-danger">*</span></label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="sort"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <label class="font_weight_bold">Hình
                                            <sup><span class="text-danger">Kích thước chuẩn</span></sup>
                                        </label>
