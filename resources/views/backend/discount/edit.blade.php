...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7">
            {{ Breadcrumbs::render('backend.discount.edit') }}
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6" style="margin: auto">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="title" value="{{old('title',$data->title)}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" readonly
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select name="type" class="form-control">
                                            <option value="1" {{old('type',$data->type)==1?'selected="selected"':''}}>Giảm số tiền
                                            </option>
                                            <option value="2" {{old('type',$data->type)==2?'selected="selected"':''}}>Giảm %
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" class="form-control form-control-line" name="value" value="{{old('value',$data->value)}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="limit" value="{{old('limit',$data->limit)}}">
                                    </div>
                                </div>
                                    ...
                                    <div class="row" style="padding: 0 15px">
                                        <div class="col-md-6">
                                            <input type="text" class="form-control form-control-line date_time_select" name="start_date"
                                                   readonly
                                                   value="{{old('start_date',$data->start_date)}}" placeholder="Ngày bắt đầu">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control form-control-line date_time_select" name="end_date"
                                                   readonly
                                                   value="{{old('end_date',$data->end_date)}}" placeholder="Ngày kết thúc">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select name="status" class="form-control">
                                            <option value="0" {{old('status',$data->status)==0?'selected="selected"':''}}>Không hoạt động
                                            </option>
                                            <option value="1" {{old('status',$data->status)==1?'selected="selected"':''}}>Hoạt động
                                            </option>
                                        </select>
                                    </div>
                                </div>
