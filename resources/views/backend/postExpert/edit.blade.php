...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.postExpert.edit') }}
        </div>
    ...
    <div class="row page-titles">
        <div class="col-md-12">
            <form class="form-horizontal" action="{{route('backend.postExpert.edit', $data->id)}}" method="post">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-body">
                                <div class="form-group form-group-sm">
                                    <label class="form-control-label font-weight-bold">Tên bài viết
                                ...
                                <div class="form-group form-group-sm">
                                    <label class="form-control-label font-weight-bold">Mô tả
                                ...
                                <div class="form-group form-group-sm">
                                    <label class="form-control-label font-weight-bold">Nội dung</label>

                                    <textarea type="text"
                                              class="form-control form-control-line form-control-sm" rows="5"
                                              id="detail"
                                              name="detail">{!! old('detail', $data->detail) !!}</textarea>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-outline-info">
                            <div class="card-body">
                                ...
                                <div class="form-group form-group-sm">
                                    <label class="form-control-label font-weight-bold">Danh mục
                                        <span class="text-danger">*</span>
                                    </label>

                                    <select class="form-control form-control-line form-control-sm" name="expert_category_id">
                                        <option value="">Chọn danh mục</option>
                                        @foreach($expert_category as $item)
                                            <option value="{{ $item->id }}" {{ $item->id == $data->expert_category_id ? 'selected' : '' }}>
                                                {{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group form-group-sm">
                                    <label class="form-control-label font-weight-bold">Thứ tự
                                        <span class="text-danger">( Điền số )</span>
                                    </label>
...
{{--                                <div class="form-group form-group-sm">--}}
{{--                                    <p><label class="form-control-label font-weight-bold">Trạng thái</label></p>--}}
...
{{--                                </div>--}}
                                ...
                                <div class="form-group">
                                    <div class="checkbox-out">
                                        <input type="checkbox" id="can_index" class="filled-in"
                                               {{old('can_index', $data->can_index)==1?'checked':''}}
                                ...
                                <div class="form-group">
                                    <label class="font-weight-bold">Hình
                                        <sup><span class="text-danger">Kích thước chuẩn: 1024 x 500</span></sup>
                                    </label>
                                        ...
                                        <div class="result">
                                            @if($thumbnail_image)
                                                <div class="thumb-nail-view">
                                                    ...
                                                    <input name="thumbnail_file_id" value="{{$thumbnail_image->id}}"
                                                           type="hidden">
                                                    <a href="javascript:;" onclick="removeFile($(this))"
                                                       data-id="{{$thumbnail_image->id}}">Xóa</a>
                                                </div>
                                            @endif
                                        </div>
                                        <div class="fallback">
                                ...
                                <div class="form-group form-group-sm">
                                    <label class="form-control-label font-weight-bold">Seo title</label>
                                ...
                                <div class="form-group form-group-sm">
                                    <label class="form-control-label font-weight-bold">Seo descriptions</label>

                                    <textarea type="text"
                                              class="form-control form-control-line form-control-sm" rows="5"
                                              name="seo_descriptions">{{old('seo_descriptions', $data->seo_descriptions)}}</textarea>
                                </div>

                                <div class="form-group form-group-sm">
                                    <label class="form-control-label font-weight-bold">Seo keywords</label>
