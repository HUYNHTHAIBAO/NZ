...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.postExpert.add') }}
        </div>
    ...
    <div class="row page-titles">
        <div class="col-md-12">
            <form class="form-horizontal" action="{{route('backend.postExpert.add')}}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <select class="form-control form-control-line form-control-sm" name="expert_category_id">
                                        ...
                                        @foreach($expert_category as $key => $item)
