...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-black font-weight-bold">Câu hỏi chuyên gia</h3>
        </div>
        <div class="col-md-7 align-self-center">
                        {{ Breadcrumbs::render('backend.questionExpert.index') }}
        </div>
    </div>
                                        ...
                                        <tr>
                                            ...
                                            @if($item->status == 1)
                                                <td class="d-flex align-items-center justify-content-end">
                                                    ...
                                                    <form
                                                        action="{{ route('backend.questionExpert.approved', ['id' => $item->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        <button type="submit"
                                                    ...
                                                    <form
                                                        action="{{ route('backend.questionExpert.reject', ['id' => $item->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        <a href="{{Route('backend.questionExpert.reject',[$item->id])}}"
