...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-black font-weight-bold">Xem hồ sơ</h3>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline-info">
                <div class="card-body row">
                    <div class="col-6">
                        <form action="{{ route('backend.expert.approvedUpdate', $dataId->id) }}" method="post">
                            @csrf
                            <div class="form-body">
                                <div class="row p-t-20">
                                    <div class="form-group col-12">
                                        <label for="category_id_expert" class="">Danh mục</label>
                                    ...
                                    <div class="form-group col-12">
                                        <label for="bio" class="">Giới thiệu</label>
                                    ...
                                    <div class="col-12 text-center">
                                        <button class="btn btn-info text-light">Duyệt hồ sơ cập nhật</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="col-6">
                        <form action="{{route('backend.expert.rejectUpdate', $dataId->id)}}" method="post">
                            @csrf
                            <div class="form-body">
                                <div class="row p-t-20">
                                    <div class="form-group col-12">
                                    ...
                                    <div class="col-12 text-center">
                                        <button class="btn btn-danger text-light">Từ chối hồ sơ cập nhật</button>
                                    </div>
                                </div>
                            </div>
                        </form>
