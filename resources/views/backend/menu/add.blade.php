...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.menu.add') }}
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="control-label text-right col-md-3">Tên menu
                                ...
                                <div class="form-group row">
                                    <label class="control-label text-right col-md-3">Trạng thái
                                        <span class="text-danger">*</span>
                                    </label>
                                ...
                                <div class="form-group row">
                                    <label class="control-label text-right col-md-3">Mô tả
                                    </label>
