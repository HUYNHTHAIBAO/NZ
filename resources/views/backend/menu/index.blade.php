...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.menu.index') }}
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-2">
                            <menu id="nestable-menu" style="padding: 0">
                                <a href="{{Route("backend.{$route_type}.add")}}" class="btn flat btn-info">
                                    Thêm mới
                                </a>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function sort_ajax() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route("backend.{$route_type}.sort")}}",
                    data: dataString,
                    cache: false,
                    dataType: 'json',
            ...
            $(document).on("click", ".del-button", function () {
                ...
                if (x) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route("backend.{$route_type}.del")}}",
            ...
            $(document).on("click", ".edit-button", function () {
                var id = $(this).data('id');
                location.href = "{{route("backend.{$route_type}.edit", '')}}/" + id;
            });
        });
