...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7">
            {{ Breadcrumbs::render('backend.banner.add') }}
        </div>
    </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control" name="type">
                                            ...
                                            {{--                                            <option value="2" {!! old('type')==2?'selected="selected"':'' !!}>--}}
                                            {{--                                                Banner thương hiệu--}}
                                            {{--                                            </option>--}}
                                            {{--                                        <option value="3" {!! old('type')==3?'selected="selected"':'' !!}>--}}
                                            {{--                                            Banner quảng cáo--}}
                                            {{--                                        </option>--}}
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <label class="font_weight_bold">Hình<sup><span class="text-danger">Kích thước chuẩn: banner chính 1921 x 601</span></sup>
                                        </label>
