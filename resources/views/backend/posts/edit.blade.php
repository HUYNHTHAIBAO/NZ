...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.posts.edit') }}
        </div>
    </div>
                    ...
                    <div class="col-md-8">
                        <div class="card card-outline-info">
                            <div class="card-body">
                                ...
                                <div class="form-group form-group-sm">
                                    <label class="form-control-label font-weight-bold">Địa chỉ cụ thể</label>
                    ...
                    <div class="col-md-4">
                        <div class="card card-outline-info">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label class="font-weight-bold">Hình share FB</label>
                                        ...
                                        <div class="result">
                                            @if($image_fb)
                                                <div class="thumb-nail-view">
                                                    ...
                                                    <input name="image_fb_file_id" value="{{$image_fb->id}}"
                                                           type="hidden">
                                                    <a href="javascript:;" onclick="removeFile($(this))"
                                                       data-id="{{$image_fb->id}}">Xóa</a>
                                                </div>
                                            @endif
                                        </div>
                                        <div class="fallback">
