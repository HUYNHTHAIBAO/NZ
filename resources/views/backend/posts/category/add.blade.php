                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-control-label font_weight_bold">Tên danh mục
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <p><label class="form-control-label font_weight_bold">Trạng thái</label></p>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox-out">
                                            ...
                                            <label for="can_index" class="font_weight_bold">Google index</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="form-control-label font_weight_bold">Mô tả</label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="font_weight_bold">Hình đại diện</label>
                                ...
                                <div class="col-md-4">
                                    <label class="font_weight_bold">Icon</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-control-label font_weight_bold">Seo title</label>
                            ...
                            <div class="form-group">
                                <label class="form-control-label font_weight_bold">Seo descriptions</label>
                            ...
                            <div class="form-group">
                                <label class="form-control-label font_weight_bold">Seo keywords</label>
