...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.posts.category.edit') }}
        </div>
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label font-weight-bold">Tên danh mục
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <p><label class="form-control-label" for="can_index">&nbsp;</label></p>
                                            <div class="checkbox-out">
                                                ...
                                                <label for="can_index" class="font-weight-bold">Google index</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">Mô tả</label>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="dropzone" id="myDropzone" action="{{route('backend.ajax.uploadImage')}}">
                                            ...
                                            <div class="result">
                                                @if($category_file_image)
                                                    <div class="thumb-nail-view">
                                                        <img src="{{$category_file_image->file_src}}" class="img-thumbnail">
                                                        <input name="thumbnail_file_id" value="{{$category_file_image->id}}" type="hidden">
                                                        <a href="javascript:;" onclick="removeFile($(this))" data-id="{{$category_file_image->id}}">Xóa</a>
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="fallback">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="dropzone" id="myDropzone2" action="{{route('backend.ajax.uploadImage')}}">
                                            ...
                                            <div class="result">
                                                @if($category_file_icon)
                                                    <div class="thumb-nail-view">
                                                        <img src="{{$category_file_icon->file_src}}" class="img-thumbnail">
                                                        <input name="icon_file_id" value="{{$category_file_icon->id}}" type="hidden">
                                                        <a href="javascript:;" onclick="removeFile($(this))" data-id="{{$category_file_icon->id}}">Xóa</a>
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="fallback">
