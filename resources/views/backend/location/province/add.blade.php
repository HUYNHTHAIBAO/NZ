...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.location.province.add') }}
        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control col-md-4" required="required"
                                                name="type">
                                            <option value="Tỉnh" {!! old('type') =='Tỉnh' ? 'selected="selected"' : '' !!}>
                                                Tỉnh
                                            </option>
                                            <option value="Thành phố" {!! old('type')== 'Thành phố' ? 'selected="selected"' : '' !!}>
                                                Thành phố
                                            </option>
                                        </select>
                                        <input type="text"
