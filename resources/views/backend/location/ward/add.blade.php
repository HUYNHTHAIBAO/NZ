...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.location.ward.add') }}
        </div>
                                    ...
                                    <select class="form-control select_district select2" name="district_id" required="required">
                                        ...
                                        @foreach($districts as $district)
                                            <option value="{{$district->id}}"
                                                    {!! old('district_id')==$district->id?'selected="selected"':'' !!}>{{$district->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control form-control col-md-3" required="required"
                                                name="type">
                                            <option value="Phường" {!! old('type') =='Phường' ? 'selected="selected"' : '' !!}>
                                                Phường
                                            </option>
                                            <option value="Xã" {!! old('type')== 'Xã' ? 'selected="selected"' : '' !!}>
                                                Xã
                                            </option>
                                            <option value="Thị trấn" {!! old('type')== 'Thị trấn' ? 'selected="selected"' : '' !!}>
                                                Thị trấn
                                            </option>
                                        </select>
                                        <input type="text"
