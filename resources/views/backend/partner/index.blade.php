...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.partner.index') }}
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2 pull-right">
                            <a href="{{Route('backend.partner.add')}}"
                                    ...
                                    <table id="table_id" class="table color-table muted-table table-striped">
                                        ...
                                        @forelse($list_data as $key => $item)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="{{Route('backend.partner.edit',[$item->id]). '?_ref=' .$current_url }}"
                                                       class="btn waves-effect waves-light btn-info btn-sm">
                                                        <i class="fa fa-pencil-square-o"></i> Sửa</a>

                                                    <a href="{{Route('backend.partner.del',[$item->id]) . '?_ref=' .$current_url }}"
