...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7">
                        {{ Breadcrumbs::render('backend.review.edit') }}
        </div>
    </div>
    ...
    <div class="row page-titles">
        <div class="col-md-12">
            <div class="card card-outline-info">
                <div class="card-body">
                    <form class="form-horizontal" action="{{route('backend.review.edit',$data->id )}}" method="post">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea class="form-control" name="desc" id="" cols="" rows="3">{{old('desc', $data->desc)}}</textarea>
                                    </div>
                                </div>
