...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.products.type.index') }}
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-2">
                            <menu id="nestable-menu" style="padding: 0">
                                @if(auth()->guard('backend')->user()->can('products.type.add'))
                                    <a href="{{Route('backend.products.type.add')}}" class="btn flat btn-info">
                                        Thêm mới
                                    </a>
                                @endif
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function sort_ajax() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('backend.products.type.sort')}}",
                    data: dataString,
                    cache: false,
                    dataType: 'json',
            ...
            $(document).on("click", ".del-button", function () {
                ...
                if (x) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route('backend.products.type.del')}}",
            ...
            $(document).on("click", ".edit-button", function () {
                var id = $(this).data('id');
                location.href = "{{route('backend.products.type.edit', '')}}/" + id;
            });
        });
