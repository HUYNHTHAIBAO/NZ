...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.products.type.edit') }}
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label">Loại danh mục</label>
                                            <select class="form-control" name="type">
                                                <option
                                                    {{old('type',$data->type) == 1 ? "selected" : ''}}
                                                    value="1">Danh mục sản phẩm
                                                </option>
                                                <option
                                                    {{old('type',$data->type) == 2 ? "selected" : ''}}
                                                    value="2">Danh mục sản phẩm ăn vặt
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            @foreach($status as $k=>$v)
                                                <input type="radio" id="status_{{$v['id']}}" name="status"
                                                       value="{{$v['id']}}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label">Màu sắc
                                                <span class="text-danger">*</span>
                                            </label>
                                            ...
                                            <div class="result">
                                                @if($category_file_image)
                                                    <div class="thumb-nail-view">
                                                        <img src="{{$category_file_image->file_src}}"
                                                             class="img-thumbnail">
                                                        <input name="thumbnail_file_id"
                                                               value="{{$category_file_image->id}}" type="hidden">
                                                        <a href="javascript:;" onclick="removeFile($(this))"
                                                           data-id="{{$category_file_image->id}}">Xóa</a>
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="fallback">
                                        ...
                                        <div class="dropzone" id="myDropzone2"
                                            ...
                                            <div class="result">
                                                @if($category_file_icon)
                                                    <div class="thumb-nail-view">
                                                        <img src="{{$category_file_icon->file_src}}"
                                                             class="img-thumbnail">
                                                        <input name="icon_file_id" value="{{$category_file_icon->id}}"
                                                               type="hidden">
                                                        <a href="javascript:;" onclick="removeFile($(this))"
                                                           data-id="{{$category_file_icon->id}}">Xóa</a>
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="fallback">
