    ...
    <div class="row page-titles">
        <div class="col-md-12">
            <div class="card card-outline-info">
                <div class="card-body">
                    <form class="form-horizontal" action="{{route('backend.expertCategory.edit', $data->id)}}" method="post">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-6 row" style="margin: auto">
                                ...
                                <div class="form-group d-flex align-items-center flex-column col-6">
                                    ...
                                    <div class="">
                                        <div style="width: 200px; height: 300px" class="dropzone  col-md-12 " id="myDropzone"
                                ...
                                <div class="form-group d-flex align-items-center flex-column col-6">
                                    ...
                                    <div class="">
                                        <div style="width: 200px; height: 300px" class="dropzone  col-md-12 " id="myDropzone2"
                                         action="{{route('backend.ajax.uploadImage')}}">
                                        <div class="dz-message">
                                            <div>
                                                <div class="message">
                                        ...
                                        <div class="result">
                                            @if(!empty($image_file_after))
                                                <div class="thumb-nail-view">
                                                    <img src="{{url('storage/uploads/'.$image_file_after->file_path.'')}}"
                                                         class="img-thumbnail"/>
                                ...
                                <div class="form-group col-12">
                                    <label for="states" class="font-weight-bold">Tags<span class="text-danger">*</span></label>
                                    <select class="js-example-basic-multiple form-group col-12" name="tags_id[]" multiple="multiple">
                                        @foreach($dataTags as $key => $item)
                                            <option value="{{ $item->id }}" {{ in_array($item->id, $selectedTags) ? 'selected' : '' }}>
                                                {{ $item->name ?? '' }}
                                            </option>
                                        @endforeach
                                    </select>
