                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2 pull-right">
                            <a href="{{Route('backend.expertCategoryTags.add')}}"
                                    ...
                                    <table id="table_id" class="table color-table muted-table table-striped">
                                        ...
                                        @forelse($data as $key => $item)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="{{Route('backend.expertCategoryTags.edit',[$item->id]). '?_ref=' .$current_url }}"
                                                       class="btn waves-effect waves-light btn-info btn-sm">
                                                        <i class="fa fa-pencil-square-o"></i> Sửa</a>

                                                    <a href="{{Route('backend.expertCategoryTags.del',[$item->id]) }}"
