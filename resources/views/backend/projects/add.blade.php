...
@section('content')
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.projects.add') }}
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group text-center">
                                    <button class="btn btn-info" type="submit">Thêm dự án</button>
                                </div>
                                    ...
                                    <select class="form-control select_province select2" name="province_id" required="required">
                                        ...
                                        @foreach($relate_data['provinces'] as $province)
                                            <option value="{{$province->id}}"
                                                    {!! old('province_id')==$province->id?'selected="selected"':'' !!}
                                    ...
                                    <select class="form-control select_district select2" name="district_id" required="required">
                                        ...
                                        @foreach($relate_data['districts'] as $districts)
                                            <option value="{{$districts->id}}"
                                                    {!! old('district_id')==$districts->id?'selected="selected"':'' !!}>{{$districts->name}}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control select_ward select2" name="ward_id" required="required">
                                        ...
                                        @foreach($relate_data['wards'] as $ward)
                                            <option value="{{$ward->id}}"
                                                    {!! old('ward_id')==$ward->id?'selected="selected"':'' !!}>{{$ward->name}}</option>
                                        @endforeach
                                    </select>
